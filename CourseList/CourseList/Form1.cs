    ...
    public partial class CourseListForm : Form
    {
        ...
        public void PaintListView(string firstCourseCode)
        {
            ...
            foreach (KeyValuePair <String,Course> course in Globals.courses.sortedList)
            {
                ...
                Course thisCourse = course.Value;
                ...
                // 22. create a new ListViewItem.ListViewSubItem named lvsi1 for the next column
                ListViewItem.ListViewSubItem lvsi1 = new ListViewItem.ListViewSubItem();

                // 23. set the column to show thisCourse.teacherEmail
                lvsi1.Text = thisCourse.teacherEmail;

                // 24. add lvsi to lvi.SubItems
                lvi.SubItems.Add(lvsi1);


                // 25. create a new ListViewItem.ListViewSubItem named lvsi2 for the next column
                ...
                lvsi2.Text = thisCourse.schedule.DaysOfWeek();

                // 27. add lvsi to lvi.SubItems
                lvi.SubItems.Add(lvsi2);

                // 28. create a new ListViewItem.ListViewSubItem named lvsi3 for the next column
                ...
                lvsi3.Text = thisCourse.schedule.GetTimes();
        ...
        private void CourseListView__ItemActivate(object sender, EventArgs e)
        {
            ...
            ListViewItem row = lv.SelectedItems[0];
            String code = row.Text;

            // 40. get the course object associated with this courseCode from Globals.courses SortedList
            Course course = Globals.courses[code];
