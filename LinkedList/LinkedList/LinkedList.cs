    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button2__Click(object sender, EventArgs e)
        {
            ...
            while (linkedListNode != null)
            {
                reverseLinkedList.AddLast(new LinkedListNode<object>(linkedListNode.Value));
                linkedListNode = linkedListNode.Previous;
            }
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            LinkedList<object> linkedList = null;
            LinkedListNode<object> linkedListNode;
            string[] s = "Because I'm sad Clap along if you feel like a room without a roof Because I'm sad Clap along if you feel like sadness is the truth sad".Split(' ');
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            string[] s = "The Spain in rain falls plain on the mainly".Split(' ');
            ...
            linkedList.AddBefore(linkedListNode2, (string)linkedListNode1.Value);
            linkedList.AddBefore(linkedListNode1, (string)linkedListNode2.Value);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            anagram.AddBefore(linkedListNode2, (string)linkedListNode1.Value);
            anagram.AddBefore(linkedListNode1, (string)linkedListNode2.Value);
            ...
            anagram.AddBefore(linkedListNode1, (string)linkedListNode2.Value);
            anagram.Remove(linkedListNode2);
            linkedListNode1 = anagram.FindLast("Y");
            anagram.Remove(linkedListNode1);
